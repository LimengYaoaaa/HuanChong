...
public class AddPetActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Button mDismissPopup;
    private final int REQUESTCODE=189;
    ...
    protected void loadData() {
        ...
        paizhao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDismissPopup.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        pop.dismiss();
                    }
...
mToPhotograph.setOnClickListener(new View.OnClickListener() {
